...
{
    public class ValueModifier004 : ValueModifier
    {
        private AnimationCurve curve;
        private float totalTime;
        private float timer;
        public ValueModifier004() { }
        public ValueModifier004(SkillValueModifier valueModifier) : base(valueModifier) { }
