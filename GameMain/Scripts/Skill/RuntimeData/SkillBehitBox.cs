...
namespace AltarOfSword
{
    public class SkillBehitBox : SkillRuntimeDataPart
    {
        ...
        {
            SkillDefined.SVMK_BBoxSiteX => SiteX = initialSite.x,
            SkillDefined.SVMK_BBoxSiteY => SiteY = initialSite.y,
            SkillDefined.SVMK_BBoxSizeX => SizeX = initialSize.x,
            SkillDefined.SVMK_BBoxSizeY => SizeY = initialSize.y,
            _ => 0
        };
