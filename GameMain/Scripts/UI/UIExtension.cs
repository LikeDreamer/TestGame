...
namespace AltarOfSword
{
    public static class UIExtension
    {
        ...
        public static bool HasUIForm(this UIComponent uiComponent, EUIForm uiFormId, string uiGroupName = null)
        {
        ...
        public static UGuiForm GetUIForm(this UIComponent uiComponent, EUIForm uiFormId, string uiGroupName = null)
        {
